<?php
/**
 * Renders the `teachable/product-updated-at` block on the server.
 *
...
do_action( 'teachable_product_updated_at', $product_id, esc_attr( $class_name . $wp_block_classes ), $wp_block_styles );
