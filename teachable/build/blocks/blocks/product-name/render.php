<?php
/**
 * Renders the `teachable/product-name` block on the server.
 *
...
do_action( 'teachable_product_name', $product_id, esc_attr( $class_name . $wp_block_classes ), $wp_block_styles );
