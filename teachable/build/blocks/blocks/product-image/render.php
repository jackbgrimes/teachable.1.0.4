<?php
/**
 * Renders the `teachable/product-image` block on the server.
 *
...
do_action( 'teachable_product_image', $product_id, esc_attr( $class_name . $wp_block_classes ), $wp_block_styles );
