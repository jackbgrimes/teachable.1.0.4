<?php
/**
 * Renders the `teachable/product-description` block on the server.
 *
...
do_action( 'teachable_product_description', $product_id, esc_attr( $class_name . $wp_block_classes ), $wp_block_styles );
