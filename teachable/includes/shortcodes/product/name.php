 ...
 * @version 1.0.0
 */
function shortcode_teachable_product_name( $atts = array() ) {
	$atts = shortcode_atts(
		array(
			'id'      => '',
			'classes' => '',
	...
	if ( ! empty( $id ) ) {
		do_action( 'teachable_product_name', $id, $atts['classes'], $atts['styles'] );
	} else {
...
add_shortcode( 'teachable_product_name', __NAMESPACE__ . '\\shortcode_teachable_product_name' );
